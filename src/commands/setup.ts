...
export const setup: Command = {
  data: new SlashCommandBuilder()
    .setName('setup')
    .setDescription(
      'Configure Scool for this server / Configurer Scool pour ce serveur',
    )
    ...
    .addSubcommand((sub) =>
      sub
        .setName('channel')
        .setDescription(
          "Set the announcement channel / Définir le salon d'annonces",
        )
    ...
    .addSubcommand((sub) =>
      sub
        .setName('role')
        .setDescription(
          'Set the Scool admin role / Définir le rôle admin Scool',
        )
        .addRoleOption((opt) =>
    ...
    .addSubcommand((sub) =>
      sub
        .setName('view')
        .setDescription(
          'View current configuration / Voir la configuration actuelle',
        ),
    ),
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    if (sub === 'view') {
      ...
      const embed = createEmbed(Colors.WHITE)
        ...
        .setDescription(
          t(lang, 'setup_summary', langStr, channelStr, roleStr, logsStr),
        )
